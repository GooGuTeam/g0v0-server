...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_beatmap_ratings_user_id"), table_name="beatmap_ratings")
    op.drop_index(op.f("ix_beatmap_ratings_beatmapset_id"), table_name="beatmap_ratings")
