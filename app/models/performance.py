...
class OsuDifficultyAttributes(DifficultyAttributes):
    ...
    reading_difficulty: float = Field(..., description="The difficulty corresponding to the reading skill.")
...
class SentakkiPerformanceAttributes(PerformanceAttributes):
    pass


class SentakkiDifficultyAttributes(DifficultyAttributes):
    pass
...
class RushPerformanceAttributes(PerformanceAttributes):
    pass


class RushDifficultyAttributes(DifficultyAttributes):
    pass


class HishigataPerformanceAttributes(PerformanceAttributes):
    pass


class HishigataDifficultyAttributes(DifficultyAttributes):
    pass


class SoyokazePerformanceAttributes(PerformanceAttributes):
    pass


class SoyokazeDifficultyAttributes(DifficultyAttributes):
    pass
...
DifficultyAttributesUnion = (
    ...
    | SentakkiDifficultyAttributes
    | TauDifficultyAttributes
    | RushDifficultyAttributes
    | HishigataDifficultyAttributes
